...
function ScriptCell({ value, onChange, placeholder, accent = "#E63946" }) {
  ...
  const handleKeyDown = (e) => {
    ...
    if ((e.metaKey || e.ctrlKey) && (e.key === "i" || e.key === "I")) { e.preventDefault(); wrap("!!"); return; }
    ...
    <div className="relative">
      {focused && (
        <div className="absolute -top-3.5 right-1 z-10 flex gap-1" onMouseDown={(e) => e.preventDefault()}>
          ...
          <button type="button" onClick={() => wrap("!!")} title="赤文字（⌘I）" className={fmtBtn} style={{ color: "#DC2645", fontWeight: 800 }}>A</button>
        </div>
      )}
